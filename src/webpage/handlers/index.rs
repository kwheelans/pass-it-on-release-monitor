...
use crate::webpage::handlers::{AppState, INDEX_PAGE_TITLE};
...
pub async fn get_ui_index_select_id(mut state: State<AppState>, Path(id): Path<i64>) -> Result<Markup, StatusCode> {
